...
VALUES ('Θησέως 70', '1995-01-01', 'Καλλιθέα', null, '1995-01-01 08:25:12.000000', 'ΤΜΗΜΑ ΠΛΗΡΟΦΟΡΙΚΗΣ ΚΑΙ ΤΗΛΕΜΑΤΙΚΗΣ (ΜΠΣ)', null, 'itp1@hua.gr', 'Κάποιο πατρώνυμο', null, '2109549101', 'Κάποιο μητρώνυμο', 'Γραμματεία', crypt('admin', gen_salt('bf')), 17671, 'Χαροκόπειο', 'itp1', '012345678', true);
